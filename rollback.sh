...
echo
echo "=== 2/5 : suppression du serveur d'expo (Docker : dockhand, dnsmasq, dnsmasq-admin, caddy, caddy-admin, webui, bastion, dashboard) ==="
...
echo
echo "=== 4/5 : demontage du reseau (profil fake-pi, reseau expo-lan) ==="
